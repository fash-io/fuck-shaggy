...
const About = () => {
  return (
    <div className="w-full min-h-screen p-10 sm:p-14 flex flex-col gap-14">
      {aboutItems.map((item, i) => (
        <div key={i} className="h-96 min-h-fit rounded-lg border-[3px] border-[#42c77c] text-white p-5 bg-[#07140c]">
